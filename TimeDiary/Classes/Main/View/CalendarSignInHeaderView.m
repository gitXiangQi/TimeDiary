...
//    [self addSubview:backBtn];
    ...
    NSMutableAttributedString *string = [[NSMutableAttributedString alloc] initWithString:@"时光日历" attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang-SC-Medium" size: 18],NSForegroundColorAttributeName: [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1.0]}];
...
//    [self addSubview:signInBtn];
    ...
    NSMutableAttributedString *desString = [[NSMutableAttributedString alloc] initWithString:@"<- 左右滑动日历查看更多 ->" attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang-SC-Medium" size: 12],NSForegroundColorAttributeName: [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1.0]}];
...
//    }];
    ...
    [desLa mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerX.equalTo(self);
        make.top.equalTo(titleLa.mas_bottom).offset(70);
