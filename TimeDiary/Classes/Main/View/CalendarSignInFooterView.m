...
- (void)setUI{
    ...
    NSMutableAttributedString *string = [[NSMutableAttributedString alloc] initWithString:@"亲爱的小主~" attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang-SC-Medium" size: 15],NSForegroundColorAttributeName: [UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1.0]}];
    la.attributedText = string;
    [self addSubview:la];
    
    UILabel *btnLa = [[UILabel alloc] init];
    NSString *str2 = @"我可以帮您回忆美好生活，点击记录";
